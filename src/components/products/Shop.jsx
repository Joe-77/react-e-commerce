...
import backgroundImg from "../../assets/product_3.png";
...
const Shop = () => {
  ...
  return (
    <div className="container mx-auto mt-5 mb-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 px-3 sm:px-0">
      <div className=" col-span-1 sm:col-span-2 lg:col-span-3 bg-gradient-to-r from-slate-200 to-slate-800 flex flex-col sm:flex-row gap-5 sm:justify-between items-center px-3 sm:px-20 py-2 h-[350px] sm:h-60 rounded-md">
        <div>
        ...
        <img
          className=" rounded-xl h-56 sm:h-full"
          src={backgroundImg}
          alt=""
        />
      </div>
