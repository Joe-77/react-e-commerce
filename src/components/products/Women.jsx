...
import backGround from "../../assets/product_6.png";
...
const Women = () => {
  ...
  return (
    <div className="container mx-auto mt-5 mb-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 px-3 sm:px-0">
      <div className=" col-span-1 sm:col-span-2 lg:col-span-3 bg-gradient-to-r from-cyan-300 to-cyan-500 flex flex-col sm:flex-row gap-5 sm:justify-between items-center px-3 sm:px-20 py-2 h-[350px] sm:h-60 rounded-md">
        <div>
